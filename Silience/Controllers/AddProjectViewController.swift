...
class AddProjectViewController: UIViewController {
    ...
    @IBAction func addNewTask(sender: Any) {
        ...
        let newTask: Projects = Projects(uniqueID: uniqueID, name: name!, startDate: startDate!, endDate: endDate!, hours: hours!, description: description!, projectType: ProjectType.project, projectComplete: false, projectFeatured: false, pictureID: "")
